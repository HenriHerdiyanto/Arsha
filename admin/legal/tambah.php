...
if (isset($_POST['Submit'])) {
    ...
    if (empty($kode) || empty($nama) || empty($keterangan) || empty($jasa) || empty($produk) || empty($harga) || empty($filename)) {
        ...
        $result = mysqli_query($koneksi, "INSERT INTO legal(kode,nama,keterangan,jasa,produk,harga,gambar) VALUES('$kode', '$nama', '$keterangan','$jasa','$produk','$harga', '$filename')");
