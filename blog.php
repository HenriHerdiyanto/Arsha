          ...
          <div class="container position-relative">
            <div class="row d-flex justify-content-center">
              <div class="col-lg-12 text-center">
                <img style="width: 100%; height:500px" src="admin/berita/image/<?= $gambar ?>"><br>
                <h2 class="mt-5"><?php echo $judul ?></h2>
                <h6>Kategori : <?php echo $kategori ?></h6>
                <h6 align="justify"><?php echo $deskripsi ?></h6>
                <!-- <a class="cta-btn" href="index.php">Kembali</a> -->
              </div>
            </div>
          </div>
        </div><!-- End Page Header -->
